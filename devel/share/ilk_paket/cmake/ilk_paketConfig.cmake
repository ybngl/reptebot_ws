...
if("TRUE" STREQUAL "TRUE")
  set(ilk_paket_SOURCE_PREFIX /home/ybngl/reptebot_ws/src/ilk_paket)
  set(ilk_paket_DEVEL_PREFIX /home/ybngl/reptebot_ws/devel)
  ...
  set(ilk_paket_INSTALL_PREFIX /home/ybngl/reptebot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ilk_paket' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ybngl/reptebot_ws/src/ilk_paket/${idir}'.  ${_report}")
    endif()
...
set(ilk_paket_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ilk_paket_EXPORTED_TARGETS ${${ilk_paket_dep}_EXPORTED_TARGETS})
endforeach()
